...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.oversketch.open_app_settings.OpenAppSettingsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin open_app_settings, com.oversketch.open_app_settings.OpenAppSettingsPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.zhalkhas.phoenix_native.PhoenixNativePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin phoenix_native, com.zhalkhas.phoenix_native.PhoenixNativePlugin", e);
    }
    try {
