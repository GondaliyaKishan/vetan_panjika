...
import 'ac_device_locks.dart';

class ACDevices extends StatefulWidget {
  const ACDevices({Key? key}) : super(key: key);

  @override
  _ACDevicesState createState() => _ACDevicesState();
}

class _ACDevicesState extends State<ACDevices> {
  ...
  getDevices(branchID, catId) {
    var apiController = ApiController();
    apiController.getAdminDevices(branchID, catId).then((value) {
      if (value != null) {
        devicesList = [];
                        ...
                        return ListTile(
                          onTap: () {
                            Navigator.push(
                              context,
                              CupertinoPageRoute(
                                builder: (context) => ACDeviceLocks(deviceName: devicesList[i].name),
                              ),
                            );
                          },
