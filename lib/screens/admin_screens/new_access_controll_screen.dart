...
class NewAccessControllScreen extends StatefulWidget {
  const NewAccessControllScreen({super.key});

  @override
  State<NewAccessControllScreen> createState() =>
      _NewAccessControllScreenState();
}

class _NewAccessControllScreenState extends State<NewAccessControllScreen> {
  @override
        ...
        children: [
              ...
              child: GestureDetector(
                ...
                child: Row(
                  children: [
                    ...
                    getCustomFont("Access Control", 20.sp, Colors.black, 1,
          ...
          Expanded(
            child: GridView(
              ...
              children: [
                dashBoardWidget("Devices", Color(0xFFE31F25).withOpacity(0.05),
                    "Attendence.png"),
